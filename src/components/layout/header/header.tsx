    ...
    >
      <div className="innerSticky text-gray-700 body-font fixed bg-white w-full h-16 sm:h-20 lg:h-24  z-20 ps-4 md:ps-0 lg:ps-6 pe-4 lg:pe-6 transition duration-200 ease-in-out">
        <div className="flex items-center justify-center mx-auto max-w-[1920px] h-full w-full">
          ...
          {/** flex-shrink-0 ms-auto lg:me-5 xl:me-8 2xl:me-10 lg:flex md:ms-6 xl:ms-10 */}
          <div className=" flex-shrink-0 ms-auto lg:me-5 xl:me-8 2xl:me-10 lg:flex md:ms-6 xl:ms-10 ">
            <LanguageSwitcher />
          </div>
